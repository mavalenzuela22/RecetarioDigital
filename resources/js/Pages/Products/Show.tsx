...
type Props = { product: ProductPayload; success?: string; indexUrl: string; editUrl: string; scenarioPriceUrl: string; scenarioRequestKey: string; manualRequestKey: string };
type PriceData = { mode: 'scenario' | 'manual'; scenario: string; price: string; confirmed: boolean; request_key: string };

export default function Show({ product, success, indexUrl, editUrl, scenarioPriceUrl, scenarioRequestKey, manualRequestKey }: Props) {
    const { cost } = product;
